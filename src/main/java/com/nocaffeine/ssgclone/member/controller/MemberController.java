...
public class MemberController {
    ...
    public ResponseDto<Void> duplicationEmail( @PathVariable("email") String email) {
    ...
    public ResponseDto<Void> changePassword(@RequestHeader("Authorization") String token,
                                               @RequestBody MemberPasswordRequestDto memberPasswordRequestDto) {
        log.info("token : {}", token);
        return memberService.changePassword(token, memberPasswordRequestDto);
    }
}
