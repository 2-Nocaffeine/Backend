...
public class AuthController {
    ...
    @Operation(summary = "소셜 회원가입", description = "소셜 회원가입", tags = {"Auth"})
    ...
    @Operation(summary = "소셜 로그인", description = "소셜 로그인", tags = {"Auth"})
    ...
    @Operation(summary = "이메일 인증코드 발송", description = "이메일 인증코드 발송", tags = {"Auth"})
    @PostMapping("/authentications/email")
    ...
    @Operation(summary = "이메일 인증코드 확인", description = "이메일 인증코드 확인", tags = {"Auth"})
    @PostMapping("/authentications/email/check")
