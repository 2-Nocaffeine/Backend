...
public class OptionSelectedProductController {
    ...
    public CommonResponse<OptionSelectedProductResponse> getOptionSelectedProduct(@PathVariable("option-selected-product-id") Long id) {
        OptionSelectedProductResponse getOptionSelectedProduct = optionSelectedProductService.getProductOptionSelected(id);
